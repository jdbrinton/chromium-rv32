...
The numbering convention: `0001-…` lives in the main Chromium repo;
all `0002-…` patches live inside one of Chromium's submodules / pinned
third-party trees (each is a separate git checkout under
`src/chromium/src/third_party/…` or `src/chromium/src/v8/`).
